...
st.markdown("""
    ...
    Upload an image of an apple, banana, or orange, and the model will predict its freshness.
    """)
...
with st.sidebar:
    ...
    st.markdown("""
    1. Upload an image of a fruit (apple, banana, or orange)
    2. The model will analyze the image
    3. View the prediction and confidence scores
    4. Explore detailed analysis and explanations
    """)
...
st.markdown("""
<div class="footer">
    <p>Built with Streamlit and TensorFlow | Fruit Freshness Classification Model</p>
